...
public class BalancedBinarySearchTree extends BinarySearchTree {
	 ...
	 * 对树进行平衡操作 
	 * 四种情况 
	 * 1.LL 右旋.以根结点为圆心，双亲结点为圆上的点，进行逆时针旋转。双亲结点代替根结点的位置，根结点成为双亲的右结点
	 * 2.RR 左旋.以跟结点为圆心，双亲结点为圆上的点，进行顺时针旋转。双亲结点代替根结点的位置，根结点成为双亲的右结点
	 * 3.LR 左旋，然后右旋 。当前插入结点代替根结点的位置，双亲结点成为当前结点的左孩子，祖先结点成为当前结点的右孩子，当前结点原来的左孩子成为双亲的右孩子，当前结点原来的右孩子，成为祖先的左孩子。
	 * 4.RL 右旋，然后左旋.。当前插入结点代替根结点的位置，双亲结点成为当前结点的右孩子，祖先结点成为当前结点的左孩子，当前结点原来的右孩子成为双亲的左孩子，当前结点原来的左孩子，成为祖先的右孩子
	 *
	 * @param node
	 *            被添加的结点
	 */
